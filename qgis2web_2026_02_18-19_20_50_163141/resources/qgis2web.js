...
map.getView().fit([-11895864.529313, 3299582.428900, -11894367.219914, 3300847.048325], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Lugares turísticos en ciudad Cuauhtémoc, Chihuahua, México</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_reasdeturismoenCuauhtmoc_1,
    colName: 'Nombre del',
    zoom: 10,
    collapsed: true,
    map: map,
